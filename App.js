...
import { StyleSheet, Text, View, TextInput, Pressable, Alert, KeyboardAvoidingView, TouchableOpacity, ScrollView, Keyboard } from 'react-native';
...
export default function App() {
  ...
  const handleSearch = () => {Alert.alert("Search press")}
      ...
      <View style={styles.Header_Footer}>
        ...
        <View style={styles.Search_Footer}>
          ...
          <View style={styles.Search_Title}>
            <TextInput style={styles.Search_Holder} placeholder={'Search'}></TextInput>
          </View> 

          <Pressable style={styles.Button_Footer} title='Search' onPress={() => handleSearch()}>
